...
class ItemController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        if(isset($validatedData['category'])){
            ...
            return redirect()->route('item.index')->with('success-message', 'Prodit ajouté avec succès!');
        }
        return redirect()->route('category.create')->with('error-message', 'Veillez selectionner le category!');
    }
